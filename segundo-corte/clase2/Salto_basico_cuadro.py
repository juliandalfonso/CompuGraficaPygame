...
'''
    def jump(self):
        if (j1.rect.bottom>rep.ALTOPANTALLA or j1.rect.bottom<=rep.ALTOPANTALLA-50):
            print"jumping False"
            self.jumping=False
            return
        elif j1.rect.bottom<=rep.ALTOPANTALLA and self.jumping==True:
            print"resta 5"
            self.vely =-5
'''
...
if __name__ == '__main__':
    ...
    while not fin:
        ...
        if j1.rect.bottom>rep.ALTOPANTALLA:
            ...
            j1.vely=0
        if jumping:
            if (j1.rect.bottom>rep.ALTOPANTALLA or j1.rect.bottom<=rep.ALTOPANTALLA-100):
                print"jumping False"
                jumping=False
